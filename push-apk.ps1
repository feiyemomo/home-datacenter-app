...
"@echo <NAS_PASSWORD>" | Set-Content $askpass -Encoding ASCII
...
$remoteApkPath = "fnos-momo@192.168.31.235:/vol1/docker/home-datacenter/data/releases/app-debug-v$version.apk"
$localNotesPath = "d:\Projects\Android\release-notes-v$version.txt"
$remoteNotesPath = "fnos-momo@192.168.31.235:/vol1/docker/home-datacenter/data/releases/release-notes-v$version.txt"
...
"@echo <NAS_PASSWORD>" | Set-Content $askpass2 -Encoding ASCII
...
if ($code -eq 0) {
    ...
    if (Test-Path $localNotesPath) {
        ...
        "@echo <NAS_PASSWORD>" | Set-Content $askpassNotes -Encoding ASCII
    ...
    "@echo <NAS_PASSWORD>" | Set-Content $askpass3 -Encoding ASCII
